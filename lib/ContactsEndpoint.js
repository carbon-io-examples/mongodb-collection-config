 ...
 *
 *    additionalOptions     - An object of additional options that should be passed into the handler
 *                            as part of the options argument.
 *
 *    additionalParameters  - An object of additional parameters which will be added to the collection
 *                            parameters. These will be passed to handlers via the options argument.
